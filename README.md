...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,365 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,408 | 🐛 338 | 🌐 Java | 📅 2026-09-09 - Texture Packer built into Libgdx
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,388 | 🐛 69 | 🌐 Game Maker Language | 📅 2026-09-23 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,195 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,194 | 🐛 130 | 🌐 C++ | 📅 2026-07-26
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 76,333 | 🐛 1,221 | 🌐 C++ | 📅 2026-09-23 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,904 | 🐛 10 | 🌐 Rust | 📅 2026-09-23 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,496 | 🐛 284 | 🌐 C++ | 📅 2026-09-19 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,386 | 🐛 118 | 🌐 Go | 📅 2026-09-22 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,131 | 🐛 12 | 🌐 C++ | 📅 2026-09-23 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,438 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,413 | 🐛 315 | 🌐 C | 📅 2026-09-20 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,766 | 🐛 84 | 🌐 Dart | 📅 2026-09-23 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,860 | 🐛 161 | 🌐 Kotlin | 📅 2026-09-19 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
...
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,886 | 🐛 34 | 🌐 C++ | 📅 2026-09-23 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,566 | 🐛 278 | 🌐 C++ | 📅 2026-09-22 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,414 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,891 | 🐛 10 | 🌐 C | 📅 2026-09-16 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,869 | 🐛 275 | 🌐 Java | 📅 2026-09-23 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,462 | 🐛 9 | 🌐 C++ | 📅 2026-09-23 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 868 | 🐛 2 | 🌐 C# | 📅 2026-09-23 - A small cross-platform 2D game framework in C#.
...
* :tada: [GameFrameX](https://github.com/GameFrameX/GameFrameX) ⭐ 654 | 🐛 5 | 🌐 C# | 📅 2026-09-14 - A cross-engine game framework: Unity and Godot clients on a single actor-model .NET server, sharing one Protobuf contract and LuBan config pipeline. AI-agent friendly: instruction docs in-repo, codegen'd protocol/config layers.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 342 | 🐛 6 | 🌐 Rust | 📅 2026-09-23 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 319 | 🐛 11 | 🌐 C++ | 📅 2026-09-23 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 81 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-23 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [Parlour](https://github.com/braedonsaunders/parlour) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Deterministic TypeScript card-game engine with a cozy playable browser table (Blitz, Wild, P2P rooms, no backend).
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,328 | 🐛 52 | 🌐 C# | 📅 2026-09-23 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,103 | 🐛 88 | 🌐 C++ | 📅 2026-09-10 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,950 | 🐛 40 | 🌐 C# | 📅 2026-08-10 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 520 | 🐛 138 | 🌐 C | 📅 2026-09-23 - free windows tracker for producing music for the NES/Famicom-systems.
...
* [awesome-gametalks](https://github.com/hzoo/awesome-gametalks) ⭐ 1,184 | 🐛 7 | 📅 2024-05-09 - A curated list of game talks (GDC, youtube, etc).
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,601 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,420 | 🐛 1,598 | 🌐 C# | 📅 2026-09-14
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,297 | 🐛 396 | 🌐 C++ | 📅 2026-09-23
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,241 | 🐛 3 | 🌐 C | 📅 2024-08-02
...
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 6,063 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,918 | 🐛 150 | 🌐 C | 📅 2026-09-23
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,594 | 🐛 1 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,348 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,547 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,221 | 🐛 233 | 🌐 C# | 📅 2026-09-02
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 144 | 🐛 3 | 🌐 C | 📅 2026-08-30 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,920 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
