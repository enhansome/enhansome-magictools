...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,334 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,312 | 🐛 335 | 🌐 Java | 📅 2026-08-12 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,843 | 🐛 321 | 🌐 GDScript | 📅 2026-08-06 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,346 | 🐛 67 | 🌐 Game Maker Language | 📅 2026-08-15 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,018 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 75,755 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-19 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,656 | 🐛 9 | 🌐 Rust | 📅 2026-08-12 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,416 | 🐛 285 | 🌐 C++ | 📅 2026-08-20 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,185 | 🐛 127 | 🌐 Go | 📅 2026-08-20 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,030 | 🐛 11 | 🌐 C++ | 📅 2026-08-09 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,335 | 🐛 316 | 🌐 C | 📅 2026-08-08 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,726 | 🐛 88 | 🌐 Dart | 📅 2026-08-20 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,585 | 🐛 333 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,404 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,867 | 🐛 38 | 🌐 C++ | 📅 2026-08-19 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,543 | 🐛 294 | 🌐 C++ | 📅 2026-07-30 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,860 | 🐛 268 | 🌐 Java | 📅 2026-08-20 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,439 | 🐛 14 | 🌐 C++ | 📅 2026-08-20 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 859 | 🐛 2 | 🌐 C# | 📅 2026-08-13 - A small cross-platform 2D game framework in C#.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 317 | 🐛 11 | 🌐 C++ | 📅 2026-08-20 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 133 | 🐛 5 | 🌐 Rust | 📅 2026-08-20 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 3,952 | 🐛 51 | 🌐 C# | 📅 2026-08-19 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,932 | 🐛 38 | 🌐 C# | 📅 2026-08-10 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,435 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,254 | 🐛 1,603 | 🌐 C# | 📅 2026-08-01
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,195 | 🐛 3 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,186 | 🐛 412 | 🌐 C++ | 📅 2026-08-20
...
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 6,016 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,872 | 🐛 140 | 🌐 C | 📅 2026-08-20
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,583 | 🐛 1 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,324 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,522 | 🐛 1 | 📅 2012-02-06
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,843 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
