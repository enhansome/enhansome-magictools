...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,385 | 🐛 338 | 🌐 Java | 📅 2026-09-09 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,912 | 🐛 336 | 🌐 GDScript | 📅 2026-08-06 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,375 | 🐛 69 | 🌐 Game Maker Language | 📅 2026-09-12 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,154 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,189 | 🐛 129 | 🌐 C++ | 📅 2026-07-26
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 76,166 | 🐛 1,229 | 🌐 C++ | 📅 2026-09-10 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,846 | 🐛 9 | 🌐 Rust | 📅 2026-09-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,474 | 🐛 284 | 🌐 C++ | 📅 2026-09-12 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,099 | 🐛 12 | 🌐 C++ | 📅 2026-09-02 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,431 | 🐛 66 | 🌐 TypeScript | 📅 2026-08-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,386 | 🐛 315 | 🌐 C | 📅 2026-09-10 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,749 | 🐛 84 | 🌐 Dart | 📅 2026-09-10 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,855 | 🐛 162 | 🌐 Kotlin | 📅 2026-07-01 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,624 | 🐛 339 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,436 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-01 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,878 | 🐛 35 | 🌐 C++ | 📅 2026-09-11 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,559 | 🐛 294 | 🌐 C++ | 📅 2026-09-12 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,866 | 🐛 289 | 🌐 Java | 📅 2026-09-12 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,453 | 🐛 14 | 🌐 C++ | 📅 2026-09-12 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [GameFrameX](https://github.com/GameFrameX/GameFrameX) ⭐ 649 | 🐛 5 | 🌐 C# | 📅 2026-09-11 - A cross-engine game framework: Unity and Godot clients on a single actor-model .NET server, sharing one Protobuf contract and LuBan config pipeline. AI-agent friendly: instruction docs in-repo, codegen'd protocol/config layers.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 317 | 🐛 11 | 🌐 C++ | 📅 2026-09-11 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [is::Engine](https://github.com/Is-Daouda/is-Engine) ⭐ 234 | 🐛 4 | 🌐 C | 📅 2026-07-07 - C++, SDL 2 and SFML game engine that allows to create games on Nintendo Switch, Web (HTML 5), Mobile and PC.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,245 | 🐛 53 | 🌐 C# | 📅 2026-09-12 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,541 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,365 | 🐛 1,591 | 🌐 C# | 📅 2026-09-04
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,248 | 🐛 405 | 🌐 C++ | 📅 2026-09-12
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,230 | 🐛 3 | 🌐 C | 📅 2024-08-02
...
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,592 | 🐛 1 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,343 | 🐛 3 | 🌐 C | 📅 2023-12-05
...
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,101 | 🐛 73 | 🌐 C | 📅 2026-02-10
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,890 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
