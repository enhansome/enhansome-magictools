...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,363 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,405 | 🐛 338 | 🌐 Java | 📅 2026-09-09 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,935 | 🐛 323 | 🌐 GDScript | 📅 2026-09-20 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,385 | 🐛 69 | 🌐 Game Maker Language | 📅 2026-09-21 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,184 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 76,305 | 🐛 1,227 | 🌐 C++ | 📅 2026-09-21 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
...
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,370 | 🐛 118 | 🌐 Go | 📅 2026-09-21 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,129 | 🐛 12 | 🌐 C++ | 📅 2026-09-21 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,404 | 🐛 315 | 🌐 C | 📅 2026-09-20 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,763 | 🐛 83 | 🌐 Dart | 📅 2026-09-21 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,629 | 🐛 338 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,446 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-21 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,885 | 🐛 34 | 🌐 C++ | 📅 2026-09-20 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,562 | 🐛 282 | 🌐 C++ | 📅 2026-09-21 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,414 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,887 | 🐛 10 | 🌐 C | 📅 2026-09-16 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,867 | 🐛 272 | 🌐 Java | 📅 2026-09-21 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,459 | 🐛 9 | 🌐 C++ | 📅 2026-09-20 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 869 | 🐛 2 | 🌐 C# | 📅 2026-09-20 - A small cross-platform 2D game framework in C#.
...
* :tada: [GameFrameX](https://github.com/GameFrameX/GameFrameX) ⭐ 652 | 🐛 5 | 🌐 C# | 📅 2026-09-14 - A cross-engine game framework: Unity and Godot clients on a single actor-model .NET server, sharing one Protobuf contract and LuBan config pipeline. AI-agent friendly: instruction docs in-repo, codegen'd protocol/config layers.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,314 | 🐛 52 | 🌐 C# | 📅 2026-09-17 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,590 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,403 | 🐛 1,598 | 🌐 C# | 📅 2026-09-14
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,288 | 🐛 396 | 🌐 C++ | 📅 2026-09-21
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,238 | 🐛 3 | 🌐 C | 📅 2024-08-02
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,917 | 🐛 149 | 🌐 C | 📅 2026-09-20
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,211 | 🐛 219 | 🌐 C# | 📅 2026-09-02
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,708 | 🐛 31 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
