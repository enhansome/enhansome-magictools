...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,344 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,348 | 🐛 339 | 🌐 Java | 📅 2026-08-25 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,864 | 🐛 326 | 🌐 GDScript | 📅 2026-08-06 - procedural texture creator made in Godot
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,106 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,183 | 🐛 129 | 🌐 C++ | 📅 2026-07-26
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 75,957 | 🐛 1,238 | 🌐 C++ | 📅 2026-08-30 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,783 | 🐛 9 | 🌐 Rust | 📅 2026-08-30 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,445 | 🐛 286 | 🌐 C++ | 📅 2026-08-30 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,239 | 🐛 129 | 🌐 Go | 📅 2026-08-25 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,063 | 🐛 11 | 🌐 C++ | 📅 2026-08-28 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,415 | 🐛 66 | 🌐 TypeScript | 📅 2026-08-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,357 | 🐛 316 | 🌐 C | 📅 2026-08-08 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,736 | 🐛 87 | 🌐 Dart | 📅 2026-08-30 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,601 | 🐛 337 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,419 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,870 | 🐛 35 | 🌐 C++ | 📅 2026-08-28 - 3D Game engine built on C++.
...
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,860 | 🐛 272 | 🌐 Java | 📅 2026-08-30 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 341 | 🐛 7 | 🌐 Rust | 📅 2026-08-30 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 206 | 🐛 7 | 🌐 C# | 📅 2026-08-22 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 133 | 🐛 5 | 🌐 Rust | 📅 2026-08-29 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
* :tada: [Chipmunk C#](https://github.com/netonjm/ChipmunkSharp) ⭐ 85 | 🐛 5 | 🌐 C# | 📅 2019-03-12 - C# implementation of the Chipmunk2D lib.
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 77 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-30 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [6502 Unit Test executor](https://github.com/AsaiYusuke/6502_test_executor) ⭐ 13 | 🐛 3 | 🌐 C++ | 📅 2026-08-24 - A cross-platform unit testing tool for MOS 6502 assembly. (i.e. NES)
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,019 | 🐛 52 | 🌐 C# | 📅 2026-08-24 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,093 | 🐛 86 | 🌐 C++ | 📅 2026-06-22 - open source tracker for Mac/Linux/Windows platforms.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,482 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,300 | 🐛 1,580 | 🌐 C# | 📅 2026-08-30
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,221 | 🐛 409 | 🌐 C++ | 📅 2026-08-30
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,887 | 🐛 141 | 🌐 C | 📅 2026-08-30
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,588 | 🐛 1 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,334 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,528 | 🐛 1 | 📅 2012-02-06
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 129 | 🐛 3 | 🌐 C | 📅 2026-08-30 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,861 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
