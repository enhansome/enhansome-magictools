...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,330 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,296 | 🐛 334 | 🌐 Java | 📅 2026-08-12 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,828 | 🐛 317 | 🌐 GDScript | 📅 2026-08-06 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,343 | 🐛 65 | 🌐 Game Maker Language | 📅 2026-08-13 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 2,973 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 75,638 | 🐛 1,231 | 🌐 C++ | 📅 2026-08-07 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,648 | 🐛 9 | 🌐 Rust | 📅 2026-08-12 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,395 | 🐛 287 | 🌐 C | 📅 2026-08-13 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,150 | 🐛 125 | 🌐 Go | 📅 2026-08-07 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,008 | 🐛 11 | 🌐 C++ | 📅 2026-08-09 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,396 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-10 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,318 | 🐛 315 | 🌐 C | 📅 2026-08-08 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,722 | 🐛 92 | 🌐 Dart | 📅 2026-08-12 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,839 | 🐛 162 | 🌐 Kotlin | 📅 2026-07-01 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,579 | 🐛 334 | 🌐 Rust | 📅 2026-08-05 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,388 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-12 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,863 | 🐛 38 | 🌐 C++ | 📅 2026-08-11 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,537 | 🐛 292 | 🌐 C++ | 📅 2026-07-30 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,434 | 🐛 12 | 🌐 C++ | 📅 2026-08-11 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 855 | 🐛 2 | 🌐 C# | 📅 2026-08-06 - A small cross-platform 2D game framework in C#.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 203 | 🐛 7 | 🌐 C# | 📅 2026-08-13 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 133 | 🐛 5 | 🌐 Rust | 📅 2026-08-11 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 3,886 | 🐛 50 | 🌐 C# | 📅 2026-08-10 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,084 | 🐛 86 | 🌐 C++ | 📅 2026-06-22 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,925 | 🐛 36 | 🌐 C# | 📅 2026-08-10 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,381 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,220 | 🐛 1,600 | 🌐 C# | 📅 2026-08-01
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,187 | 🐛 3 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,167 | 🐛 414 | 🌐 C++ | 📅 2026-08-13
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 8,006 | 🐛 52 | 🌐 ActionScript | 📅 2026-08-11
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,863 | 🐛 140 | 🌐 C | 📅 2026-08-13
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,570 | 🐛 1 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,315 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,518 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,190 | 🐛 216 | 🌐 C# | 📅 2026-06-18
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 130 | 🐛 5 | 🌐 C | 📅 2026-08-08 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
