...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,356 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,894 | 🐛 331 | 🌐 GDScript | 📅 2026-08-06 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,365 | 🐛 68 | 🌐 Game Maker Language | 📅 2026-09-06 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,137 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 76,129 | 🐛 1,225 | 🌐 C++ | 📅 2026-09-08 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,829 | 🐛 9 | 🌐 Rust | 📅 2026-09-06 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,468 | 🐛 285 | 🌐 C++ | 📅 2026-09-07 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,300 | 🐛 128 | 🌐 Go | 📅 2026-09-08 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,089 | 🐛 11 | 🌐 C++ | 📅 2026-09-02 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,383 | 🐛 316 | 🌐 C | 📅 2026-09-05 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,744 | 🐛 84 | 🌐 Dart | 📅 2026-09-08 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,621 | 🐛 339 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
...
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,877 | 🐛 35 | 🌐 C++ | 📅 2026-09-07 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,558 | 🐛 294 | 🌐 C++ | 📅 2026-07-30 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,414 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,872 | 🐛 9 | 🌐 C | 📅 2026-09-05 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,864 | 🐛 277 | 🌐 Java | 📅 2026-09-08 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [GameFrameX](https://github.com/GameFrameX/GameFrameX) ⭐ 645 | 🐛 5 | 🌐 C# | 📅 2026-09-07 - A cross-engine game framework: Unity and Godot clients on a single actor-model .NET server, sharing one Protobuf contract and LuBan config pipeline. AI-agent friendly: instruction docs in-repo, codegen'd protocol/config layers.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,218 | 🐛 52 | 🌐 C# | 📅 2026-09-04 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,944 | 🐛 39 | 🌐 C# | 📅 2026-08-10 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,526 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,348 | 🐛 1,589 | 🌐 C# | 📅 2026-09-04
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,244 | 🐛 405 | 🌐 C++ | 📅 2026-09-08
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,224 | 🐛 3 | 🌐 C | 📅 2024-08-02
...
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 6,047 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,897 | 🐛 148 | 🌐 C | 📅 2026-09-08
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,200 | 🐛 211 | 🌐 C# | 📅 2026-09-02
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,878 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
