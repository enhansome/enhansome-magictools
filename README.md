...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,395 | 🐛 337 | 🌐 Java | 📅 2026-09-09 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,918 | 🐛 314 | 🌐 GDScript | 📅 2026-09-14 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,377 | 🐛 69 | 🌐 Game Maker Language | 📅 2026-09-14 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,173 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,191 | 🐛 129 | 🌐 C++ | 📅 2026-07-26
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 76,198 | 🐛 1,232 | 🌐 C++ | 📅 2026-09-15 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,869 | 🐛 9 | 🌐 Rust | 📅 2026-09-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,487 | 🐛 285 | 🌐 C++ | 📅 2026-09-15 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,337 | 🐛 123 | 🌐 Go | 📅 2026-09-15 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,109 | 🐛 12 | 🌐 C++ | 📅 2026-09-02 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,390 | 🐛 315 | 🌐 C | 📅 2026-09-10 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,753 | 🐛 84 | 🌐 Dart | 📅 2026-09-14 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,858 | 🐛 162 | 🌐 Kotlin | 📅 2026-07-01 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,626 | 🐛 339 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,436 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-15 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,880 | 🐛 35 | 🌐 C++ | 📅 2026-09-14 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,559 | 🐛 285 | 🌐 C++ | 📅 2026-09-15 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,414 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,875 | 🐛 10 | 🌐 C | 📅 2026-09-05 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,867 | 🐛 285 | 🌐 Java | 📅 2026-09-15 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,456 | 🐛 10 | 🌐 C++ | 📅 2026-09-15 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 942 | 🐛 18 | 🌐 C# | 📅 2026-09-15 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 867 | 🐛 3 | 🌐 C# | 📅 2026-08-31 - A small cross-platform 2D game framework in C#.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 342 | 🐛 6 | 🌐 Rust | 📅 2026-09-14 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 318 | 🐛 11 | 🌐 C++ | 📅 2026-09-14 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 210 | 🐛 8 | 🌐 C# | 📅 2026-09-09 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,273 | 🐛 53 | 🌐 C# | 📅 2026-09-14 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,100 | 🐛 87 | 🌐 C++ | 📅 2026-09-10 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,947 | 🐛 39 | 🌐 C# | 📅 2026-08-10 - FamiStudio NES Music Editor.
...
* [awesome-gametalks](https://github.com/hzoo/awesome-gametalks) ⭐ 1,181 | 🐛 6 | 📅 2024-05-09 - A curated list of game talks (GDC, youtube, etc).
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,551 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,376 | 🐛 1,593 | 🌐 C# | 📅 2026-09-14
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,264 | 🐛 397 | 🌐 C++ | 📅 2026-09-15
...
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 6,052 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,908 | 🐛 145 | 🌐 C | 📅 2026-09-13
...
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,540 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,202 | 🐛 208 | 🌐 C# | 📅 2026-09-02
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,584 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,103 | 🐛 73 | 🌐 C | 📅 2026-02-10
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,703 | 🐛 31 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,897 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
