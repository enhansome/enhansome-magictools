...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,366 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,409 | 🐛 339 | 🌐 Java | 📅 2026-09-24 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,940 | 🐛 325 | 🌐 GDScript | 📅 2026-09-20 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,390 | 🐛 69 | 🌐 Game Maker Language | 📅 2026-09-23 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,199 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,196 | 🐛 130 | 🌐 C++ | 📅 2026-07-26
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 76,340 | 🐛 1,223 | 🌐 C++ | 📅 2026-09-24 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,935 | 🐛 10 | 🌐 Rust | 📅 2026-09-23 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,501 | 🐛 284 | 🌐 C++ | 📅 2026-09-24 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,408 | 🐛 119 | 🌐 Go | 📅 2026-09-22 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,137 | 🐛 12 | 🌐 C++ | 📅 2026-09-24 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,439 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,415 | 🐛 315 | 🌐 C | 📅 2026-09-20 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,766 | 🐛 84 | 🌐 Dart | 📅 2026-09-24 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,861 | 🐛 161 | 🌐 Kotlin | 📅 2026-09-19 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,632 | 🐛 338 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,449 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-24 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,885 | 🐛 34 | 🌐 C++ | 📅 2026-09-24 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,567 | 🐛 280 | 🌐 C++ | 📅 2026-09-24 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,869 | 🐛 273 | 🌐 Java | 📅 2026-09-24 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,462 | 🐛 10 | 🌐 C++ | 📅 2026-09-24 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 869 | 🐛 2 | 🌐 C# | 📅 2026-09-23 - A small cross-platform 2D game framework in C#.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 319 | 🐛 11 | 🌐 C++ | 📅 2026-09-24 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 213 | 🐛 9 | 🌐 C# | 📅 2026-09-09 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 81 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-24 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,333 | 🐛 52 | 🌐 C# | 📅 2026-09-24 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,604 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,433 | 🐛 1,598 | 🌐 C# | 📅 2026-09-14
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,296 | 🐛 396 | 🌐 C++ | 📅 2026-09-24
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,920 | 🐛 150 | 🌐 C | 📅 2026-09-23
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,225 | 🐛 233 | 🌐 C# | 📅 2026-09-02
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,921 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
