...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,390 | 🐛 337 | 🌐 Java | 📅 2026-09-09 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,916 | 🐛 333 | 🌐 GDScript | 📅 2026-09-13 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,375 | 🐛 69 | 🌐 Game Maker Language | 📅 2026-09-13 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,163 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,190 | 🐛 129 | 🌐 C++ | 📅 2026-07-26
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 76,184 | 🐛 1,230 | 🌐 C++ | 📅 2026-09-10 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,855 | 🐛 9 | 🌐 Rust | 📅 2026-09-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,481 | 🐛 284 | 🌐 C++ | 📅 2026-09-13 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,319 | 🐛 122 | 🌐 Go | 📅 2026-09-11 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,102 | 🐛 12 | 🌐 C++ | 📅 2026-09-02 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,389 | 🐛 315 | 🌐 C | 📅 2026-09-10 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,750 | 🐛 86 | 🌐 Dart | 📅 2026-09-13 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,857 | 🐛 162 | 🌐 Kotlin | 📅 2026-07-01 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,625 | 🐛 339 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
...
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,560 | 🐛 290 | 🌐 C++ | 📅 2026-09-13 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,866 | 🐛 290 | 🌐 Java | 📅 2026-09-13 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,453 | 🐛 13 | 🌐 C++ | 📅 2026-09-13 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 942 | 🐛 18 | 🌐 C# | 📅 2026-09-07 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 867 | 🐛 2 | 🌐 C# | 📅 2026-08-31 - A small cross-platform 2D game framework in C#.
...
* :tada: [GameFrameX](https://github.com/GameFrameX/GameFrameX) ⭐ 649 | 🐛 5 | 🌐 C# | 📅 2026-09-13 - A cross-engine game framework: Unity and Godot clients on a single actor-model .NET server, sharing one Protobuf contract and LuBan config pipeline. AI-agent friendly: instruction docs in-repo, codegen'd protocol/config layers.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 341 | 🐛 7 | 🌐 Rust | 📅 2026-09-13 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
* :tada: [is::Engine](https://github.com/Is-Daouda/is-Engine) ⭐ 235 | 🐛 4 | 🌐 C | 📅 2026-07-07 - C++, SDL 2 and SFML game engine that allows to create games on Nintendo Switch, Web (HTML 5), Mobile and PC.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,253 | 🐛 53 | 🌐 C# | 📅 2026-09-13 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,099 | 🐛 87 | 🌐 C++ | 📅 2026-09-10 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,946 | 🐛 39 | 🌐 C# | 📅 2026-08-10 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,545 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,367 | 🐛 1,591 | 🌐 C# | 📅 2026-09-04
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,254 | 🐛 404 | 🌐 C++ | 📅 2026-09-13
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,231 | 🐛 3 | 🌐 C | 📅 2024-08-02
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,904 | 🐛 144 | 🌐 C | 📅 2026-09-13
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,202 | 🐛 212 | 🌐 C# | 📅 2026-09-02
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,584 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,102 | 🐛 73 | 🌐 C | 📅 2026-02-10
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,891 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
