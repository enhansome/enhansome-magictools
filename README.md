...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,368 | 🐛 338 | 🌐 Java | 📅 2026-09-04 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,874 | 🐛 329 | 🌐 GDScript | 📅 2026-08-06 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,359 | 🐛 68 | 🌐 Game Maker Language | 📅 2026-09-04 - Powerful node-based VFX editor for pixel art
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,120 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 76,064 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-04 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,791 | 🐛 9 | 🌐 Rust | 📅 2026-08-30 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,458 | 🐛 287 | 🌐 C++ | 📅 2026-09-04 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,274 | 🐛 128 | 🌐 Go | 📅 2026-09-04 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,077 | 🐛 11 | 🌐 C++ | 📅 2026-09-02 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,373 | 🐛 319 | 🌐 C | 📅 2026-09-02 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,739 | 🐛 85 | 🌐 Dart | 📅 2026-09-04 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,611 | 🐛 338 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,867 | 🐛 9 | 🌐 C | 📅 2026-09-02 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,863 | 🐛 282 | 🌐 Java | 📅 2026-09-04 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [GameFrameX](https://github.com/GameFrameX/GameFrameX) ⭐ 643 | 🐛 5 | 🌐 C# | 📅 2026-09-03 - A cross-engine game framework: Unity and Godot clients on a single actor-model .NET server, sharing one Protobuf contract and LuBan config pipeline. AI-agent friendly: instruction docs in-repo, codegen'd protocol/config layers.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 208 | 🐛 8 | 🌐 C# | 📅 2026-08-22 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 79 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-31 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,144 | 🐛 52 | 🌐 C# | 📅 2026-09-04 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,938 | 🐛 38 | 🌐 C# | 📅 2026-08-10 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,514 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,336 | 🐛 1,591 | 🌐 C# | 📅 2026-09-01
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,229 | 🐛 408 | 🌐 C++ | 📅 2026-09-03
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,216 | 🐛 3 | 🌐 C | 📅 2024-08-02
...
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 6,044 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,892 | 🐛 142 | 🌐 C | 📅 2026-09-02
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,198 | 🐛 206 | 🌐 C# | 📅 2026-09-02
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 133 | 🐛 3 | 🌐 C | 📅 2026-08-30 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,870 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
