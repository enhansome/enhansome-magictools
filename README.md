...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,336 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,323 | 🐛 336 | 🌐 Java | 📅 2026-08-12 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,847 | 🐛 321 | 🌐 GDScript | 📅 2026-08-06 - procedural texture creator made in Godot
...
* :tada: [Sprite Fusion Pixel Art Cleaner](https://www.spritefusion.com/pixel-snapper) - Convert messy AI-generated pixel art into true, pixel-perfect pixel art. [Source](https://github.com/Hugo-Dz/spritefusion-pixel-snapper) ⭐ 3,052 | 🐛 0 | 🌐 Rust | 📅 2026-07-16
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,179 | 🐛 129 | 🌐 C++ | 📅 2026-07-26
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 75,810 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-19 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,751 | 🐛 9 | 🌐 Rust | 📅 2026-08-12 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,424 | 🐛 285 | 🌐 C++ | 📅 2026-08-22 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,198 | 🐛 128 | 🌐 Go | 📅 2026-08-21 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,031 | 🐛 11 | 🌐 C++ | 📅 2026-08-09 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,409 | 🐛 66 | 🌐 TypeScript | 📅 2026-08-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,336 | 🐛 316 | 🌐 C | 📅 2026-08-08 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,728 | 🐛 88 | 🌐 Dart | 📅 2026-08-20 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,847 | 🐛 162 | 🌐 Kotlin | 📅 2026-07-01 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,591 | 🐛 333 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,409 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,869 | 🐛 38 | 🌐 C++ | 📅 2026-08-22 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,546 | 🐛 293 | 🌐 C++ | 📅 2026-07-30 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,861 | 🐛 271 | 🌐 Java | 📅 2026-08-22 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,441 | 🐛 10 | 🌐 C++ | 📅 2026-08-22 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 859 | 🐛 2 | 🌐 C# | 📅 2026-08-21 - A small cross-platform 2D game framework in C#.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 204 | 🐛 7 | 🌐 C# | 📅 2026-08-22 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 133 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 3,960 | 🐛 50 | 🌐 C# | 📅 2026-08-19 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 520 | 🐛 139 | 🌐 C | 📅 2026-07-14 - free windows tracker for producing music for the NES/Famicom-systems.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,446 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,260 | 🐛 1,603 | 🌐 C# | 📅 2026-08-01
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,200 | 🐛 3 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,191 | 🐛 412 | 🌐 C++ | 📅 2026-08-20
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 8,013 | 🐛 49 | 🌐 ActionScript | 📅 2026-08-22
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,856 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 6,019 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,875 | 🐛 141 | 🌐 C | 📅 2026-08-22
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,585 | 🐛 1 | 🌐 C++ | 📅 2015-09-03
...
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,094 | 🐛 73 | 🌐 C | 📅 2026-02-10
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,849 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
