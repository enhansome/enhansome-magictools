...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,362 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,930 | 🐛 323 | 🌐 GDScript | 📅 2026-09-20 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,380 | 🐛 69 | 🌐 Game Maker Language | 📅 2026-09-17 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 76,285 | 🐛 1,227 | 🌐 C++ | 📅 2026-09-18 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,877 | 🐛 10 | 🌐 Rust | 📅 2026-09-16 - a retro game engine for Python.
...
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 13,362 | 🐛 118 | 🌐 Go | 📅 2026-09-18 - Distributed server for social and realtime games and apps.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 13,125 | 🐛 12 | 🌐 C++ | 📅 2026-09-18 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,399 | 🐛 316 | 🌐 C | 📅 2026-09-10 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,760 | 🐛 85 | 🌐 Dart | 📅 2026-09-18 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,630 | 🐛 339 | 🌐 Rust | 📅 2026-08-18 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,445 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-15 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,884 | 🐛 34 | 🌐 C++ | 📅 2026-09-18 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,562 | 🐛 281 | 🌐 C++ | 📅 2026-09-20 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,414 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,884 | 🐛 10 | 🌐 C | 📅 2026-09-16 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,867 | 🐛 270 | 🌐 Java | 📅 2026-09-20 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,458 | 🐛 9 | 🌐 C++ | 📅 2026-09-20 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 344 | 🐛 6 | 🌐 Rust | 📅 2026-09-14 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,305 | 🐛 52 | 🌐 C# | 📅 2026-09-17 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 19,589 | 🐛 15 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 17,401 | 🐛 1,598 | 🌐 C# | 📅 2026-09-14
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,284 | 🐛 395 | 🌐 C++ | 📅 2026-09-20
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,237 | 🐛 3 | 🌐 C | 📅 2024-08-02
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,917 | 🐛 147 | 🌐 C | 📅 2026-09-20
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,205 | 🐛 214 | 🌐 C# | 📅 2026-09-02
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,704 | 🐛 31 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
